...
const About = () => {
  return (
    <section
      id="about"
      className="py-4 px-4 sm:px-[7vw] md:px-[7vw] lg:px-[20vw] font-sans mt-16 md:mt-24 lg:mt-32"
    >
      <div className="flex flex-col md:flex-row justify-between items-start gap-8">
        ...
        <div className="w-full md:w-1/2 text-center md:text-left order-1 md:order-1">
          ...
          {/* Resume Button */}
          <a
            href="https://drive.google.com/file/d/16na3ceC58cpSHx1JcT00LIMGfucQlD-b/view?usp=sharing"
            target="_blank"
